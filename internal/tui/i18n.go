...
var zhStrings = map[string]string{
	...
	"catalog_live":          "实时",
	"catalog_fallback":      "快照",
	"catalog_never_fetched": "从未获取",
	"catalog_fetch_failed":  "获取失败",
	"catalog_updated_ago":   "更新于 %s 前",
	"model_stats":           "模型统计",
	"model":                 "模型",
	"requests":              "请求数",
	"tokens":                "Tokens",
...
var enStrings = map[string]string{
	...
	"catalog_never_fetched": "never fetched",
	"catalog_fetch_failed":  "fetch failed",
	"catalog_updated_ago":   "updated %s ago",
