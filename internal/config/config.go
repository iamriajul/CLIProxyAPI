...
type Config struct {
	...
	// vertex, aistudio, antigravity, claude, codex, kimi, muse, opencode, xai.
	//
	...
	// Supported channels include: vertex, aistudio, antigravity, claude, codex, kimi, muse, opencode, xai, and OAuth plugin provider keys.
	//
