...
type Config struct {
	...
	// vertex, aistudio, antigravity, claude, codex, kimi, muse, xai.
	//
	...
	// Supported channels include: vertex, aistudio, antigravity, claude, codex, kimi, muse, xai, and OAuth plugin provider keys.
	//
