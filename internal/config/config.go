...
type Config struct {
	...
	// vertex, aistudio, antigravity, claude, codex, kimi, muse, opencode, xai, zai.
	//
	...
	// Supported channels include: vertex, aistudio, antigravity, claude, codex, kimi, muse, opencode, xai, zai, and OAuth plugin provider keys.
	//
