...
type Config struct {
	...
	// vertex, aistudio, antigravity, claude, codex, kimi, muse, opencode, xai, meta.
	//
	...
	// Supported channels include: vertex, aistudio, antigravity, claude, codex, kimi, muse, opencode, xai, meta, and OAuth plugin provider keys.
	//
