...
type Config struct {
	...
	// vertex, aistudio, antigravity, claude, codex, kimi, opencode, xai, zai, meta.
	//
	...
	// Supported channels include: vertex, aistudio, antigravity, claude, codex, kimi, opencode, xai, zai, meta, and OAuth plugin provider keys.
	//
