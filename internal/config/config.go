...
type Config struct {
	...
	// vertex, aistudio, antigravity, claude, codex, kimi, opencode, xai, meta.
	//
	...
	// Supported channels include: vertex, aistudio, antigravity, claude, codex, kimi, opencode, xai, meta, and OAuth plugin provider keys.
	//
